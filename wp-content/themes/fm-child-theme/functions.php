...
function dh_add_documentation_content() {
...
function dh_add_developer_documentation_content() {
	// Output heading
	echo '<div class="wrap">';
...
function dh_add_site_options_content() {
	// Output heading
	echo '<div id="dh_site_options" class="wrap">';
...
require_once "_assets/inc/classes/class-dh-form.inc.php";
