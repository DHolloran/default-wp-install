 ...
 *
 * @since 1.1
 * @copyright Dan Holloran "To infinity and beyond" -Buzz Lightyear
 * @author Dan Holloran <dan@freemanhelp.com>
 */
class Fm_form {
	 ...
	 *
	 *
	 * @param string  $action HTML form action attribute default '?'.
	 * @param string  $method HTML form method attribute default 'post'.
	 * @param array   $args   HTML form attributes class,style, and id default array().
	 * @param boolean $echo   Whether to echo out or return the HTML default true.
	 *
	 * @return string Created HTML form tag.
	 */
	 ...
	 * @param boolean $echo   Whether to echo out or return the HTML default true.
	 *
	 * @return string Created HTML form tag for upload forms.
	 */
	 ...
	 *
	 *
	 * @param string  $form  HTML form for attribute, usually the same as the id and name, default none (required).
